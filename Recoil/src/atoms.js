...
export const notifications = atom({
  ...
  default:
    selector({
        ...
        get: async () => {
          try {
            const response = await axios.get("https://mocki.io/v1/ab6edaca-826d-4974-a6b6-2aff9542d29b") // Fetch notifications from the server
      ...
      })  // Default static value for notification counts
});
